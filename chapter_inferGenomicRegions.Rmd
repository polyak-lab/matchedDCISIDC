...
Pthresh=0.1
AllDCNGR=GRanges(seqnames = AllDCN$chrom, ranges = IRanges(start=AllDCN$start.pos, end=AllDCN$end.pos), ampDel=ifelse(AllDCN$call=="+", 1, ifelse(AllDCN$call=="-", -1, 0 ) ), sample=AllDCN$sampleID, case=substr(AllDCN$sampleID, 1, 1), type=substr(AllDCN$sampleID, 2, 5))
...
Map1[i, ]=sapply(1:ncol(SRTdfcastTum2), function(x) JT.test(as.numeric(pull(SRTThorsson2, DNames[2])), SRTdfcastCall2[, x], labs=c("-1", "0", "1"))$p.value)
...
WindowReg$TCGA.ERpos.Cor.TILFrac[a1]=Map2[1, ]
WindowReg$TCGA.ERpos.Cor.Macrophage=""
WindowReg$TCGA.ERpos.Cor.Macrophage[a1]=Map2[2, ]
WindowReg$TCGA.ERpos.Cor.LIscore=""
WindowReg$TCGA.ERpos.Cor.LIscore[a1]=Map2[3, ]
WindowReg$TCGA.ERpos.Cor.IFNG=""
WindowReg$TCGA.ERpos.Cor.IFNG[a1]=Map2[4, ]
WindowReg$TCGA.ERpos.Cor.TGFB=""
WindowReg$TCGA.ERpos.Cor.TGFB[a1]=Map2[5, ]
WindowReg$TCGA.ERpos.Cor.WoundHealing=""
WindowReg$TCGA.ERpos.Cor.WoundHealing[a1]=Map2[6,  ]
```
...
WindowReg$TCGA.ERneg.Cor.TILFrac[a1]=Map2[1, ]
WindowReg$TCGA.ERneg.Cor.Macrophage=""
WindowReg$TCGA.ERneg.Cor.Macrophage[a1]=Map2[2, ]
WindowReg$TCGA.ERneg.Cor.LIscore=""
WindowReg$TCGA.ERneg.Cor.LIscore[a1]=Map2[3, ]
WindowReg$TCGA.ERneg.Cor.IFNG=""
WindowReg$TCGA.ERneg.Cor.IFNG[a1]=Map2[4, ]
WindowReg$TCGA.ERneg.Cor.TGFB=""
WindowReg$TCGA.ERneg.Cor.TGFB[a1]=Map2[5, ]
WindowReg$TCGA.ERneg.Cor.WoundHealing=""
WindowReg$TCGA.ERneg.Cor.WoundHealing[a1]=Map2[6,  ]
```
...
DNames=colnames(AbbaClin2B)[c(5, 15:19)]
