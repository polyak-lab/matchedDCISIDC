...
barplot(lxImmFrac, beside=T, xlab = "proportion of Immune cells", col=pal2sub, horiz = T, las=2, main="Immune")
...
tempA=MHsumm[ 3,]
 ...
 dfall$type="gridshift"
 ggplot(MHmelt2, aes(x=Var1, y=meanV, col=mean))+geom_point()+geom_errorbar(aes(ymin=lowV, ymax=higv), width=.2)+
        ggtitle("case8 dcis Morisita-Horn variation of index")+theme_bw()+theme(axis.text.x = element_text(angle = 90, hjust = 1))
