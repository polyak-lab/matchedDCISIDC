...
sampid="9dcis"
palcols=cols_d4[c(4, 3:2, 5)]#pal1[c(4, 3:2, 5)]#cols_d4[c(4, 3:2, 5)] #edit this 
...
refineArea=which(all9meta$type=="DCIS" & all9meta$scene!="scene001") #"IDC" & all9meta$scene!="scene003")
...
save(DistMat,knnDistMatrix, idc8_ci,  MHsummGrid, MHsummNoTum, MHsummNoImm, MHsummExcBoth, dfall3, MHmelt,
